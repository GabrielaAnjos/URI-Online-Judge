 ...
 * como altura, espessura e quantidade de galhos, para ele conseguir pendurar muitos enfeites nela.
 *
 * Roberto quer que sua árvore tenha pelo menos 200 centímetros de altura, mas não quer que ela seja maior
 * do que 300 centímetros, ou a árvore não irá caber em sua casa.
...
public class URI3040_A_Arvore_de_Natal {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < N; i++) {
            int h = sc.nextInt();
            int e = sc.nextInt();
            int g = sc.nextInt(); // galhos

            if (h >= 200 && h <= 300 && e >= 50 && g >= 150){
